...
/**
 * This class represents the configuration of the Oracle construct package.
 *
 * @author Thomas Biesaart
 */
public class OracleXillPlugin extends JDBCXillPlugin {
    @Override
    protected Class<? extends ConnectionFactory> connectionFactory() {
        return OracleDatasourceFactory.class;
    }

    @Override
    protected Class<? extends StatementSyntaxFactory> selectStatementFactory() {
        return OracleStatementSyntaxFactory.class;
    }
}
