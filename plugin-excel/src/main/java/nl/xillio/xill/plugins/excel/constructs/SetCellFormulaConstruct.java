...
/**
 * Construct to set a cell to a formula.
 *
 * @author Geert Konijnendijk
 */
public class SetCellFormulaConstruct extends AbstractSetCellConstruct{
    @Override
    public ConstructProcessor prepareProcess(ConstructContext context) {
        return new ConstructProcessor(
                SetCellFormulaConstruct::process,
    ...
    static MetaExpression process(MetaExpression sheet, MetaExpression column, MetaExpression row, MetaExpression value) {
        return setCell(sheet, column, row, value, TRUE);
    }
}
