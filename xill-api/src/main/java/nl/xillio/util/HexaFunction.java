 ...
 * @param <X> the fifth argument type
 * @param <R> the result type
 */
@FunctionalInterface
public interface HexaFunction<S, T, U, V, W, R, X> {
	/**
	 ...
	 * @param x the sixth function argument
	 * @return the function result
	 */
	R apply(final S s, final T t, final U u, final V v, final W w, final X x);
}
