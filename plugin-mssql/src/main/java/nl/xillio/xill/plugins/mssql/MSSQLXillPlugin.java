...
/**
 * This class represents the configuration of the MSSQL construct package.
 *
 * @author Thomas Biesaart
 */
public class MSSQLXillPlugin extends JDBCXillPlugin {
    @Override
    protected Class<? extends ConnectionFactory> connectionFactory() {
        return MSSQLConnectionStringFactory.class;
    }

    @Override
    protected Class<? extends StatementSyntaxFactory> selectStatementFactory() {
        return MSSQLStatementSyntaxFactory.class;
    }
}
