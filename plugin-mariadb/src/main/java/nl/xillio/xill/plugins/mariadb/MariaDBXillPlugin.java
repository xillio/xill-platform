 ...
 */
package nl.xillio.xill.plugins.mariadb;
...
/**
 * This class represents the configuration of the MariaDB construct package.
 *
 * @author Thomas Biesaart
 */
public class MariaDBXillPlugin extends JDBCXillPlugin {

    @Override
    protected Class<? extends ConnectionFactory> connectionFactory() {
        return MariaDBConnectionFactory.class;
    }

    @Override
    protected Class<? extends StatementSyntaxFactory> selectStatementFactory() {
        return MariaDBStatementSyntaxFactory.class;
    }
}
