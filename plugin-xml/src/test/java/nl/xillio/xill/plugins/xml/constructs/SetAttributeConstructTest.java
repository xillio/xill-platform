...
/**
 * Tests for the {@link SetAttributeConstructTest}
 *
 * @author Zbynek Hochmann
 */
public class SetAttributeConstructTest {
    ...
    public void testProcess() {
        ...
        // Run
        MetaExpression result = SetAttributeConstruct.process(xmlNodeVar, textVar, MockUtils.mockStringExpression(null), nodeService);

        // Verify
        verify(nodeService).setAttribute(any(), anyString(), any());
    ...
    public void testProcessNodeNull() {
        ...
        // Run
        SetAttributeConstruct.process(xmlNodeVar, textVar, MockUtils.mockStringExpression(null), nodeService);
    }
}