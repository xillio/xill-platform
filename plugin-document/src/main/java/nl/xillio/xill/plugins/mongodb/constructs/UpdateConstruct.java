...
public class UpdateConstruct extends AbstractCollectionApiConstruct {
    ...
    protected UpdateOptionsFactory updateOptionsFactory;

    @Inject
    void setUpdateOptionsFactory(UpdateOptionsFactory updateOptionsFactory) {
    ...
    MetaExpression process(MetaExpression[] arguments, MongoCollection<Document> collection, ConstructContext context) {
        ...
        return processResult(tryUpdate(collection, filter, update, options), context);
    }
