...
(function() {
    ...
    this.onMouseWheel = function(ev) {
        // Do not respond to scroll events when there is no limit to the size of the editor
        // Prevents other elements from responding to the event
        if (this.editor.getOption("maxLines") != Infinity) {
            if (ev.getAccelKey())
                return;
