...
public class PropertyServiceTest extends TestUtils {
    ...
    public void testGetPropertyFromProjectOverride() throws Exception {
        ...
        PropertyService propertyService = new PropertyService(new Properties(), fileSystemAccess);
    ...
    public void testPropertySubstitution() {
        ...
        String value = new PropertyService(properties, mock(FileSystemAccess.class)).getFormattedProperty("greet", null, new ConstructContext(
