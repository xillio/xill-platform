...
public class XillWorkerIT extends AbstractTestNGSpringContextTests {
    ...
    public void testMultipleWorkers() throws XillCompileException, XillInvalidStateException, XillNotFoundException {
        Map<String, Object> arguments = new HashMap<>();
        arguments.put("input", 42);

        XillWorker worker = new XillWorker(runtimeProvider.get(), deployer.getWorkingDirectory(), RobotDeployer.RETURN_ROBOT_NAME);
    ...
    public void testAbort() throws Exception {
        XillWorker worker = new XillWorker(runtimeProvider.get(), deployer.getWorkingDirectory(), RobotDeployer.WAIT_ROBOT_NAME);
